...
function PaginationNumber({
  ...
  const className = clsx(
    'flex size-8 items-center justify-center text-sm border dark:border-accent  rounded-md',
    {
...
function PaginationArrow({
  ...
  const className = clsx(
    'flex size-8 items-center justify-center border dark:border-accent rounded-md',
    {
