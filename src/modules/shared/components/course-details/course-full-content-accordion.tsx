...
export function CourseFullContentAccordion({ sections }: Props) {
    ...
    <Accordion type="multiple" className="space-y-2">
      {sections.map((section) => (
        <AccordionItem
          key={section.id}
          value={section.id}
          className="overflow-hidden rounded-none border last:border-b"
        >
              ...
              {section.lectures.map((l) => {
                ...
                return (
                  <div
                    ...
                    className={`flex cursor-pointer items-center justify-between border p-3 transition-all ${
                      isSelected
